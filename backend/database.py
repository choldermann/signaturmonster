...
async def init_db():
    from models import Signature, Rule, User, Setting, SenderProfile, SMTPAccount, Disclaimer, Banner, SMTPUser, LogEntry, ImageAsset, Campaign, MailLog, MailQueueEntry, SenderSlot
    async with engine.begin() as conn:
        ...
        for migration in [
            ...
            "ALTER TABLE mail_logs ADD COLUMN message_b64 TEXT",
        ]:
            try:
